...
use Exception; // Ավելացրինք այս տողը, որպեսզի Exception-ի տակ կարմիր չգծի
...
class ProductController extends AbstractController
{
    ...
    public function index(ProductRepository $productRepository): Response
    {
        ...
        // Կանխում ենք վնասված/ջնջված կատեգորիաների սխալը
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($imageFile) {
                ...
                try {
                    ...
                    // Սխալի դեպքում կարող ես թողնել նույնը կամ լոգ անել
                }
            }
